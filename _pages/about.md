...
I like formalizing vague and wild ideas. If you think I can help you, contact me!

I am in the Job market! Please contact me if you have an open position!

I am currently a postdoctoral researcher at the Indian Institute of Science, working in the Computer Science and Automation (CSA) department. I completed my PhD under the supervision of Bhavana Kanukurthi. Before that, I earned a Master's degree in Computer Science from Indian Statistical Institute, and an undergraduate degree in Physics from the Indian Institute of Science.*/

My research interests lie broadly in cryptography and related areas of theoretical computer science. More recently, I have become particularly interested in the quantum aspects of computation and cryptography, including quantum algorithms, quantum complexity, and quantum cryptographic protocols.

I enjoy formalizing intuitive, vague, or seemingly wild ideas into precise mathematical frameworks. If you think our interests align, I would be happy to hear from you.
...
Research, for me, is the process of finding the right definitions that make ill-defined questions meaningful—and occasionally solvable. <!--I am fascinated by the gap between intuition and formal reasoning. -->Much of my research revolves around turning informal security notions, computational assumptions, and cryptographic folklore into precise mathematical statements that can be reasoned with formally. For example [in this CCS paper](https://eprint.iacr.org/2024/1011), we study how intuitive notions of real-world behavior can be modeled as rational adversaries in secure computation. <!--I enjoy discovering the right abstraction for a problem. -->Often, once the right abstraction is found, the solution becomes almost inevitable. I like proofs that explain, definitions that clarify, and assumptions that are no stronger than necessary. If our interests overlap, or if you think I might be able to help with a problem, I would be glad to hear from you.
...
### Cryptography beyond the blackboard!
While much of my work is theoretical, <!--I am particularly interested in cryptographic systems that can influence real-world public infrastructure. -->I am currently working on and particularly drawn to problems where rigorous cryptographic guarantees meet practical deployment constraints and real-world public infrastructure, especially in settings involving large populations and diverse trust assumptions.
Public systems including digital currencies, cross-chain interoperability, secure digital identity, and election systems are some examples where where security guarantees must coexist with usability, scalability, and institutional realities. <!--efficiency of the system is as important if not more than cryptographic guarantees. -->For such system, understanding how existing social and institutional mechanisms—such as identity verification, physical audits, and trusted public processes—can be incorporated into cryptographic protocols to obtain stronger security and verifiability guarantees without imposing excessive and often prohibitive complexity, something a lot of hardcore cryptographic solutions suffer from. Rather than replacing current systems entirely, I am interested in approaches that leverage existing institutional structures and physical-world checks to achieve stronger security and verification guarantees with minimal additional overhead.
<!--I am interested in understanding how cryptographic systems can remain secure when deployed in the real world, where security depends not only on mathematical assumptions but also on institutions, incentives, and human behavior. My long-term goal is to develop foundations for cryptographic infrastructure that is both theoretically sound and practically deployable at societal scale.-->
