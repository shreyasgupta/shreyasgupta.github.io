...
While much of my work is theoretical, I am particularly interested in cryptographic systems that can influence real-world public infrastructure. I am drawn to problems where rigorous cryptographic guarantees meet practical deployment constraints, especially in settings involving large populations and diverse trust assumptions.
Examples include digital currencies, cross-chain interoperability, secure digital identity, and election systems. I am especially interested in understanding how existing social and institutional mechanisms—such as identity verification, physical audits, and trusted public processes—can be incorporated into cryptographic protocols to obtain stronger security and verifiability guarantees without imposing excessive complexity, somthing a lot of solutions suffer from. Rather than replacing current systems entirely, I am interested in approaches that leverage existing institutional structures and physical-world checks to achieve stronger security guarantees with minimal additional overhead.
